...
pursuer.V   =  100; % velocity magnitude, m/s
...
target.N   =  280; % north pos, m
target.E   =  160;   % east pos, m
target.Nv  =  10; % north velocity, m/s
target.Ev  =  50; % east velocity, m/s
...
dt = 1/1000;     % time-step size, seconds
